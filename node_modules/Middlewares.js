...
define([
    ...
    exports.locals = function(req, res, next) {
        ...
        res.locals.labels = misc.getLanguage(req.user? req.user.lang : 'en');
        res.locals.routes = Router.getRoutes();
        res.locals.routes.generate = Router.generate;
        next();
    };
