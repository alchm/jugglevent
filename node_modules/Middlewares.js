...
exports.locals = function(req, res, next) {
        ...
        res.locals.labels = require('Miscellaneous').getLanguage(req.user? req.user.lang : 'en');
        res.locals.routes = require('../routes/Routes').toObject();
        res.locals.routes.generate = require('../routes/Routes').generate;
        next();
 };
