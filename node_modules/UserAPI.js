...
exports.updateLanguage = function(req, done) {
    User.findOne({ '_id': req.user._id }, function(err,user){
...
exports.getDashboardData = function(req, done) {
    User.findOne({ 'username': req.params.username }, function(err, datas) {
        done(err, datas);
    });
}

exports.getAssociations = function(req, done) {
    User.findOne({ 'username': req.params.username })
        .populate('associations', 'name contact nbFollowers')
        .exec(function(err, data) {
            if(!err) done(null, data);
            else done(err, null);
        });
}